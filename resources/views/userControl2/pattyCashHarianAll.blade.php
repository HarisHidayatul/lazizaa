    ...
    <div class="d-flex justify-content-center">
        <div class="container1">
            ...
            <div class="d-flex justify-content-between boxTop">
                <div class="subBoxTop subActive" onclick="goToPattyCashBelum();">Belum</div>
                <div class="subBoxTop" onclick="goToPattyCashSudah();">Sudah</div>
            </div>
            ...
            <div class="d-flex justify-content-between boxDetail">
                ...
                <div>
                    ...
                    <div class="detailRev">CU &#10132; <span style="color: #008000;">10</span></div>
                    <div class="detailRev">Total &#10132; <span style="color: #008000;">Rp. 20.222</span></div>
                </div>
            </div> --}}
            <div id="dataRev"></div>
        </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="menuSidebar">
                        ...
                        <div style="background: #FFEAEF;border-radius: 0px 0px 6px 6px;" id="revisiTab">
                            <div style="content: '';height:5px;"></div>
                            <div class="row rowRequest activeRequest" onclick="goToRevisiPattyCash();">Sales</div>
                            <div class="row rowRequest">Waste</div>
                            <div class="row rowRequest">Pembelian</div>
                            <div style="content: '';height:10px;"></div>
                        </div>
...
<script>
    ...
    function goToRevSales(idSalesFill) {
        ...
        window.location.href = "{{ url('user/rev/pattyCashHarian/all/date') }}" + '/' + idSalesFill;
    }

    function showRevAll() {
        $.ajax({
            url: "{{ url('pattyCash/show/revision/outlet') }}" + '/' + "{{ session('idOutlet') }}",
            type: 'get',
