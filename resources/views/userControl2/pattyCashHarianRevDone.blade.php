...
<body>
    ...
    <div class="d-flex justify-content-center">
        <div class="container1">
            <div class="revHeader">Revisi pembelian</div>
            <div class="d-flex justify-content-between boxTop">
                <div class="subBoxTop" onclick="goToPattyCashBelum();">Belum</div>
                <div class="subBoxTop subActive" onclick="goToPattyCashSudah();">Sudah</div>
            </div>
...
<script>
    ...
    function goToRevSales(idPattyCashFill) {
        window.location.href = "{{ url('user/rev/pattyCashHarian/done/date') }}" + '/' + idPattyCashFill;
    }

    function showRevAll() {
        $.ajax({
            url: "{{ url('pattyCash/show/revision/done/outlet') }}" + '/' + "{{ session('idOutlet') }}",
            type: 'get',
                    ...
                    for (var j = 0; j < obj.itemPattyCash[i].Item.length; j++) {
                        for (var k = 0; k < obj.itemPattyCash[i].Item[j].Item.length; k++) {
                            dataRev +=
                                ...
                                obj.itemPattyCash[i].Item[j].Item[k].idPattyCashFill +
                                ');">';
                            ...
                            dataRev += obj.itemPattyCash[i].Item[j].Item[k].pattyCash;
                            dataRev += '</div><div class="detailSubTitle">';
                            dataRev += obj.itemPattyCash[i].Item[j].Item[k].namaPengisi;
                            dataRev += '</div></div></div><div><div style="content: ' + "'';" +
                                'height: 6px;"></div>';
                            dataRev += '<div class="arrowRight">&#10095;</div>';
                            // if (obj.itemPattyCash[i].Item[j].Item[k].idCuRev == 3) {
                            //     dataRev +=
                            //         '<div class="detailRev">CU &#10132; <span style="color: #FFA500;">';
                            //     dataRev += obj.itemPattyCash[i].Item[j].Item[k].cuQty;
                            //     dataRev += '</span></div>';
                            // }
                            // if (obj.itemPattyCash[i].Item[j].Item[k].idTotalRev == 3) {
                            //     dataRev +=
                            //         '<div class="detailRev">Total &#10132; <span style="color: #FFA500;">Rp. ';
                            //     dataRev += obj.itemPattyCash[i].Item[j].Item[k].totalQty;
                            //     dataRev += '</span></div>';
                            // }
                            dataRev += '</div></div>';
                        }
