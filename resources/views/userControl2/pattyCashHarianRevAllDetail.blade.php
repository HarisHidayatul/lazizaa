...
<head>
    ...
    <title>Detail Pembelian Harian</title>
    <style>
        ...
        <div class="revisiWrap">
            ...
            <div class="d-flex justify-content-between">
                <div>
                    ...
                    <div class="detailSubRev">CU <span id="cuRev">0</span></div>
                </div>
                <div class="borderRev"></div>
                <div style="text-align: end;">
                    <div class="titleSubRev">Total</div>
                    <div class="detailSubRev">Rp <span id="totalRev">0</span></div>
                </div>
            </div>
            <div style="content: ''; height: 10px;"></div>
        </div>
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                for (var i = 0; i < obj.length; i++) {
                    ...
                    // dataFill += obj[i].type;
                    dataFill += '</div>';
                    for (var j = 0; j < obj[i].pattyCash.length; j++) {
                        dataFill += '<div class="d-flex justify-content-start">';
                        dataFill += '<div class="itemSales">' + obj[i].pattyCash[j].Item + '</div>';
                        if ((obj[i].pattyCash[j].idQtyRev == 2) || (obj[i].pattyCash[j].idTotalRev == 2)) {
                            var urlImage = "{{ url('img/icon/tertunda.png') }}";
                            dataFill += '<img src="' + urlImage + '" class="iconStatus" alt="icon status">';
                        } else if ((obj[i].pattyCash[j].idQtyRev == 3) || (obj[i].pattyCash[j].idTotalRev ==
                                3)) {
                        ...
                        dataFill += '<div class="cuVal">' + obj[i].pattyCash[j].qty + '</div></div>';
                        ...
                        detailPengisi += '<div class="detailFullName">' + obj[i].pattyCash[j].namaPengisi +
                            '</div></div>';
                        detailPengisi += '<div class="row"><div class="detailSales">';
                        detailPengisi += obj[i].pattyCash[j].Item;
                        detailPengisi += '</div></div></div></div>';

                        if (indexRow == 0) {
                            namaPengisi1 = obj[i].pattyCash[j].namaPengisi[0];
                        }
                        if (indexRow == 1) {
                            namaPengisi2 = obj[i].pattyCash[j].namaPengisi[0];
                        }
                        if (indexRow == 2) {
                            namaPengisi3 = obj[i].pattyCash[j].namaPengisi[0];
                        }
                        indexRow++;
                    }
                    dataFill += '</div>';
