    ...
    <div class="d-flex justify-content-start containerBottom">
        <div class="container" style="margin-left: 5px;margin-right: 10px">
            ...
            <div class="input-group mb-3" style="margin-top: 10px">
                <input type="number" class="form-control jumlahInput" placeholder="0">
                <div class="input-group-append">
                    <span class="input-group-text satuan" style="background: white">gr</span>
                </div>
            </div>
            ...
            <div class="row rowDetail">
                <div class="col-2"><img src="{{ url('img/dashboard/laporanWaste.png') }}" alt="waste"
                        style="height: 40px"></div>
                <div class="col-8">
                    <div class="row menuDetail">Ayam Geprek</div>
                    <div class="row jenisDetail">Menu</div>
                </div>
                <div class="col-2 satuanDetail">5 gr</div>
            </div>
            <div style="content: ''; height: 50px"></div>
        </div>
    </div>
...
<script>
    ...
    function radioSelBrand(selectIndex) {
        ...
        for (var i = 0; i < objSelect?.length; i++) {
            dataDropdown += '<div class="itemSelect" onclick="selectIndex(';
            dataDropdown += i;
            dataDropdown += ')">';
    ...
    function selectIndex(selectIndex) {
        //Off kan drop down
        dropdownItem = false;
        document.getElementById('selectItem').style.visibility = "hidden";
