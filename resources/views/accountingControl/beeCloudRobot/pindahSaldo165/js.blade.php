...
@section('robotjs')
    <script>
        $(document).ready(function() {
            document.getElementById("pindahSaldo165RobotSubMenu").classList.add("active");
        })
        $(document).ready(function() {
        ...
        function getListAllFilter() {
            ...
            var urlAll = "{{ url('robot/mutasi165PindahSaldo/show/all') }}";
            $.ajax({
                url: urlAll,
                type: 'get',
                data: {
        ...
        function deleteVerifikasi(idRobotMutasi165PindahSaldo) {
            $.ajax({
                url: "{{ url('robot/mutasi165PindahSaldo/delete') }}",
                type: 'delete',
                data: {
                    "_token": "{{ csrf_token() }}",
                    idRobotMutasi165PindahSaldo: idRobotMutasi165PindahSaldo
                },
                success: function(response) {
                    getListAllFilter();
                },
        ...
        function sendVerifikasi(idMutasiTransaksi) {
            $.ajax({
                url: "{{ url('robot/mutasi165PindahSaldo/create') }}",
                type: 'post',
                data: {
                    "_token": "{{ csrf_token() }}",
