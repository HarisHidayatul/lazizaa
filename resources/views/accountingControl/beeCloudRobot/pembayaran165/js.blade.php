...
@section('robotjs')
    <script>
        $(document).ready(function() {
            document.getElementById("pembayaran165RobotSubMenu").classList.add("active");
        })
        $(document).ready(function() {
        ...
        function getListAllFilter() {
            ...
            var urlAll = "{{ url('robot/mutasi165Pembayaran/show/all') }}";
            $.ajax({
                url: urlAll,
                type: 'get',
                data: {
        ...
        function deleteVerifikasi(idRobot165Pembayaran) {
            $.ajax({
                url: "{{ url('robot/mutasi165Pembayaran/delete') }}",
                type: 'delete',
                data: {
                    "_token": "{{ csrf_token() }}",
                    idRobot165Pembayaran: idRobot165Pembayaran
                },
                success: function(response) {
                    getListAllFilter();
                },
        ...
        function sendVerifikasi(idMutasiTransaksi) {
            $.ajax({
                url: "{{ url('robot/mutasi165Pembayaran/create') }}",
                type: 'post',
                data: {
                    "_token": "{{ csrf_token() }}",
