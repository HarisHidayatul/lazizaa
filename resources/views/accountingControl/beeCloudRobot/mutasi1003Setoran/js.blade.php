...
@section('robotjs')
    <script>
        $(document).ready(function() {
            document.getElementById("mutasi1003SetoranRobotSubMenu").classList.add("active");
        })
        $(document).ready(function() {
        ...
        function getListAllFilter() {
            ...
            var urlAll = "{{ url('robot/mutasi1003Setoran/show/all') }}";
            $.ajax({
                url: urlAll,
                type: 'get',
                data: {
        ...
        function deleteVerifikasi(idRobotMutasi1003Setoran) {
            $.ajax({
                url: "{{ url('robot/mutasi1003Setoran/delete') }}",
                type: 'delete',
                data: {
                    "_token": "{{ csrf_token() }}",
                    idRobotMutasi1003Setoran: idRobotMutasi1003Setoran
                },
                success: function(response) {
                    getListAllFilter();
                },
        ...
        function sendVerifikasi(idMutasiTransaksi) {
            $.ajax({
                url: "{{ url('robot/mutasi1003Setoran/create') }}",
                type: 'post',
                data: {
                    "_token": "{{ csrf_token() }}",
