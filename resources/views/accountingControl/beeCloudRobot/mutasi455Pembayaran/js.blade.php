...
@section('robotjs')
    <script>
        $(document).ready(function() {
            document.getElementById("mutasi455PembayaranRobotSubMenu").classList.add("active");
        })
        $(document).ready(function() {
        ...
        function getListAllFilter() {
            ...
            var urlAll = "{{ url('robot/mutasi455Pembayaran/show/all') }}";
            $.ajax({
                url: urlAll,
                type: 'get',
                data: {
        ...
        function deleteVerifikasi(idRobotMutasi455Pembayaran) {
            $.ajax({
                url: "{{ url('robot/mutasi455Pembayaran/delete') }}",
                type: 'delete',
                data: {
                    "_token": "{{ csrf_token() }}",
                    idRobotMutasi455Pembayaran: idRobotMutasi455Pembayaran
                },
                success: function(response) {
                    getListAllFilter();
                },
        ...
        function sendVerifikasi(idMutasiTransaksi) {
            $.ajax({
                url: "{{ url('robot/mutasi455Pembayaran/create') }}",
                type: 'post',
                data: {
                    "_token": "{{ csrf_token() }}",
